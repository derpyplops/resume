    ...
    \runsubsection{Singapore AI Safety Institute (AISI)}
    \descript{| Special Projects Associate }
    ...
    \location{Apr 2024 – November 2024}
    \vspace{\topsep}
    \vspace{-3mm}
    \begin{tightemize}
    ...
    \runsubsection{Machine Alignment Theory Scholars (MATS)}
    \descript{| Research Engineer }
